    ...
    <main className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Effective date: 2026-01-13</p>
        </div>

        {/* Content Card */}
        <div className="p-2 md:p-10 space-y-8">
          <Section title="1. Introduction">
            <p>Welcome to UltraFueling.</p>
            <p>
              UltraFueling ("us", "we", or "our") operates{" "}
              <strong className="text-foreground">ultrafueling.net</strong>{" "}
              (hereinafter referred to as "Service").
            </p>
            <p>
              Our Privacy Policy governs your visit to ultrafueling.net, and
          ...
          <Section title="2. Definitions">
            <p>
              ...
              ultrafueling.net website operated by UltraFueling.
            </p>
            <p>
              ...
              data (or from those and other information either in our possession
              or likely to come into our possession).
            </p>
            <p>
              <strong className="text-foreground">USAGE DATA</strong> is data
            ...
            <p>
              <strong className="text-foreground">DATA CONTROLLER</strong> means
            ...
            <p>
              <strong className="text-foreground">DATA SUBJECT</strong> is any
              living individual who is the subject of Personal Data.
            </p>
            <p>
              <strong className="text-foreground">THE USER</strong> is the
          ...
          <Section title="4. Types of Data Collected">
            ...
            <p className="font-semibold text-foreground mt-6">Usage Data</p>
            <p>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong className="text-foreground">Session Cookies:</strong> We
            ...
            <p className="font-semibold text-foreground mt-6">Other Data</p>
            <p>
          ...
          <Section title="5. Use of Data">
            <p>UltraFueling uses the collected data for various purposes:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <Section title="7. Transfer of Data">
            <p>
            ...
            <p>
              If you are located outside Bulgaria and choose to provide
            ...
            <p>
              UltraFueling will take all the steps reasonably necessary to
          ...
          <Section title="8. Disclosure of Data">
            <p>
          ...
          <Section title="9. Security of Data">
            <p>
          ...
          <Section title="10. Your Data Protection Rights Under GDPR">
            <p>
          ...
          <Section title="11. Your Data Protection Rights under CalOPPA">
            <p>
          ...
          <Section title="12. Your Data Protection Rights under CCPA">
            <p>
          ...
          <Section title="13. Service Providers">
            <p>
          ...
          <Section title="16. Behavioral Remarketing">
            <p>
          ...
          <Section title="18. Links to Other Sites">
            <p>
          ...
          <Section title="19. Children's Privacy">
            <p>
          ...
          <p className="text-muted-foreground text-sm pt-4 border-t border-border">
            This Privacy Policy was created for ultrafueling.net on 2026-01-13.
          </p>
        </div>
      </div>
    </main>
