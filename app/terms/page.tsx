import { Section } from "@/utils/small-functions/section";
        ...
        <div className="space-y-8 p-2 md:p-10">
          <Section title="1. Introduction">
            ...
            <p>
              ...
              use of our website located at ultrafueling.net (together or
              individually "Service") operated by UltraFueling.
            </p>
            <p>
          ...
          <Section title="2. Communications">
            <p>
              ...
              emailing at support@ultrafueling.net.
            </p>
          </Section>
          ...
          <Section title="4. Contests, Sweepstakes and Promotions">
            <p>
          ...
          <Section title="5. Subscriptions">
            ...
            <p>
              ...
              cancel it or UltraFueling cancels it. You may cancel your
              Subscription renewal either through your online account management
              page or by contacting support@ultrafueling.net customer support
              team.
            </p>
            <p>
              A valid payment method is required to process the payment for your
              subscription. You shall provide UltraFueling with accurate and
              ...
              information, you automatically authorize UltraFueling to charge
              all Subscription fees incurred through your account to any such
              payment instruments.
            </p>
            <p>
              Should automatic billing fail to occur for any reason,
              UltraFueling reserves the right to terminate your access to the
          ...
          <Section title="6. Free Trial">
            <p>
              UltraFueling may, at its sole discretion, offer a Subscription
            ...
            <p>
              ...
              Trial, you will not be charged by UltraFueling until Free Trial
            ...
            <p>
              At any time and without notice, UltraFueling reserves the right to
          ...
          <Section title="7. Fee Changes">
            <p>
              UltraFueling, in its sole discretion and at any time, may modify
              Subscription fees for the Subscriptions. Any Subscription fee
              change will become effective at the end of the then-current
              Billing Cycle.
            </p>
            <p>
              UltraFueling will provide you with a reasonable prior notice of
          ...
          <Section title="9. Content">
            ...
            <p>
              UltraFueling has the right but not the obligation to monitor and
              edit all Content provided by users.
            </p>
            <p>
              In addition, Content found on or through this Service are the
              property of UltraFueling or used with permission. You may not
          ...
          <Section title="10. Prohibited Uses">
            ...
            <ul className="ml-4 list-inside list-disc space-y-2">
              ...
              <li>
                ...
                means to access Service for any purpose.
              </li>
              <li>
              ...
              <li>
                ...
                or disrupt any parts of Service.
              </li>
              <li>
          ...
          <Section title="12. No Use By Minors">
            <p>
          ...
          <Section title="14. Intellectual Property">
            <p>
              ...
              exclusive property of UltraFueling and its licensors. Service is
          ...
          <Section title="15. Copyright Policy">
            <p>
            ...
            <p>
              ...
              via email to support@ultrafueling.net, with the subject line:
          ...
          <Section title="16. DMCA Notice and Procedure for Copyright Infringement Claims">
            <p>
          ...
          <Section title="17. Error Reporting and Feedback">
            <p>
              You may provide us either directly at support@ultrafueling.net or
              ...
              sub-licensable, unlimited and perpetual right to use Feedback in
              any manner and for any purpose.
            </p>
          </Section>

          <Section title="18. Links To Other Web Sites">
            <p>
              Our Service may contain links to third party web sites or services
              that are not owned or controlled by UltraFueling.
            </p>
            <p>
              UltraFueling has no control over, and assumes no responsibility
          ...
          <Section title="20. Limitation Of Liability">
            <p className="text-foreground uppercase">
              ...
              ARISES. EXCEPT AS PROHIBITED BY LAW, IF THERE IS LIABILITY FOUND
              ON THE PART OF COMPANY, IT WILL BE LIMITED TO THE AMOUNT PAID FOR
              THE PRODUCTS AND/OR SERVICES, AND UNDER NO CIRCUMSTANCES WILL
              THERE BE CONSEQUENTIAL OR PUNITIVE DAMAGES. SOME STATES DO NOT
          ...
          <Section title="22. Governing Law">
            <p>
              ...
              laws of Bulgaria, which governing law applies to agreement without
          ...
          <Section title="23. Changes To Service">
            <p>
          ...
          <Section title="24. Amendments To Terms">
            <p>
          ...
          <Section title="25. Waiver And Severability">
            <p>
